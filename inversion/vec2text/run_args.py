...
class TrainingArguments(transformers.TrainingArguments):
    ...
    num_workers_multiplier: int = field(
        default=1,
        metadata={
            "help": (
    ...
    def __post_init__(self):
        ...
        self.dataloader_num_workers = num_workers * self.num_workers_multiplier \
            if hasattr(self, "num_workers_multiplier") else num_workers
        print(f"Set num workers to {self.dataloader_num_workers}")
